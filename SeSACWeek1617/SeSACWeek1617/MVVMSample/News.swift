...
extension News {
    private static func itemsInternal() -> [NewsItem] {
        return [
            NewsItem(title: "Conference 2019 Registration Now Open",
                     date: DateComponents(year: 2019, month: 3, day: 14),
                     body: """
            ...
            NewsItem(title: "Conference18 Video Subtitles Now in More Languages",
                     date: DateComponents(year: 2019, month: 8, day: 8),
                     body: """
            ...
            NewsItem(title: "Lunchtime Inspiration",
                     date: DateComponents(year: 2019, month: 6, day: 8),
                     body: """
